...
if (isset($_POST['update_student'])) {
    ...
    if ($dataUpdate) {
        // echo '<script>alert("Success...");window.location.href="pdo.php";</script>';
        header("Location:pdo.php?msg=1");
    }
}
                                ...
                                <tbody>
                                    ...
                                    foreach ($rows as $row) { ?>
                                        <tr>
                                            ...
                                            <td> <a href="pdo.php?edit_student=<?php echo $row->id; ?>" class="btn btn-warning" >Edit</a></td>

                                            <td> <a href="pdo.php?delete_student=<?php echo $row->id?>" class="btn btn-danger" onclick="return confirm('Bhai Sache Delete Karvo 6 Data?');">Delete</a></td>
                                        </tr>
                                    <?php }
                                    ?>
